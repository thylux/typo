...
Article.create(:allow_comments => true, :allow_pings => true, :author => "ned", :body => "Winter is comming!", :guid => "1bf3e2ca-ed7b-4562-8a4a-8ce8438822d8", :id => 2, :permalink => "winter", :post_type => "read", :published => true, :published_at => "2015-02-05 10:00:00 UTC", :settings => {"password"=>""}, :state => "published", :text_filter_id => 5, :title => "Hello World!", :type => "Article", :user_id => 2)
Article.create(:allow_comments => true, :allow_pings => true, :author => "Yggritte", :body => "You know nothing, Jon Snow!", :guid => "1bf3e2ca-ed7b-4562-8a4a-8ce8438822e8", :id => 3, :permalink => "nothing", :post_type => "read", :published => true, :published_at => "2015-02-05 12:00:00 UTC", :settings => {"password"=>""}, :state => "published", :text_filter_id => 5, :title => "Hello World!", :type => "Article", :user_id => 3)
